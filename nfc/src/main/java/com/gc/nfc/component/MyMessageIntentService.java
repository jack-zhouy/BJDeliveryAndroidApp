...
import static com.gc.nfc.component.MyMessageReceiver.REC_TAG;
...
//        MainApplication.setConsoleText("收到一条推送通知 ： " + title + ", summary:" + summary);
        System.out.print("收到一条推送通知 ： " + title + ", summary:" + summary);
    }
...
//        MainApplication.setConsoleText(cPushMessage.getTitle() + ", content:" + cPushMessage.getContent());
        System.out.print("收到一条推送消息 ： " + cPushMessage.getTitle() + ", content:" + cPushMessage.getContent());
    }
    ...
    protected void onNotificationOpened(Context context, String title, String summary, String extraMap) {
        System.out.print("onNotificationOpened ： " + " : " + title + " : " + summary + " : " + extraMap);
...
//        MainApplication.setConsoleText("onNotificationRemoved ： " + messageId);
    ...
    protected void onNotificationReceivedInApp(Context context, String title, String summary, Map<String, String> extraMap, int openType, String openActivity, String openUrl) {
        System.out.print("onNotificationReceivedInApp ： " + " : " + title + " : " + summary + " : " + extraMap);
